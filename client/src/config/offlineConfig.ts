...
export const OFFLINE_CONFIG = {
  ...
  RECONNECTION_DELAY: parseInt(process.env.NEXT_PUBLIC_OFFLINE_RECONNECTION_DELAY || '500', 10),
  PERIODIC_SYNC_INTERVAL: parseInt(process.env.NEXT_PUBLIC_OFFLINE_PERIODIC_SYNC || '10000', 10),
