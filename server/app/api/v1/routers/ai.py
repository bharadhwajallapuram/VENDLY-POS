...
def forecast_sales(request: ForecastRequest):
    ...
    dates, sales = forecast_service.moving_average_forecast(product_id, forecast_days=request.days)
...
def detect_anomalies(request: AnomalyDetectRequest):
    ...
    anomalies = anomaly_service.detect_anomalies(sales_data, threshold=request.threshold)
