...
class InventoryService:
    ...
    def get_low_stock_products(
        ...
        """
        query = db.query(m.Product).filter(
        ...
        for product in products:
            ...
            if threshold is not None:
                ...
                is_low = product.quantity <= product.min_quantity and product.min_quantity > 0
            ...
            if is_low:
                result.append({
                    ...
                    "min_qty": product.min_quantity,
                    "shortage": product.min_quantity - product.quantity if product.min_quantity > product.quantity else 0,
    ...
    def get_inventory_summary(db: Session) -> Dict[str, Any]:
        ...
        low_stock = sum(1 for p in products if p.quantity <= p.min_quantity and p.quantity > 0)
