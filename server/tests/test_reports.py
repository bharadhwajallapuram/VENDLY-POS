...
class TestReportsEndpoints:
    ...
    def create_sales_data(self, client: TestClient, auth_headers: dict):
        ...
        for _ in range(3):
            client.post(
                ...
                json={
                    "items": [
                        {"product_id": product1["id"], "quantity": 2, "unit_price": 50.00, "discount": 0}
                    ],
                    "payment_method": "cash",
                    "discount": 0
                },
        ...
        for _ in range(2):
            client.post(
                ...
                json={
                    "items": [
                        {"product_id": product2["id"], "quantity": 1, "unit_price": 30.00, "discount": 0}
                    ],
                    "payment_method": "card",
                    "discount": 0
                },
    ...
    def test_get_sales_summary(self, client: TestClient, auth_headers: dict, create_sales_data):
    ...
    def test_get_sales_summary_with_date_range(self, client: TestClient, auth_headers: dict, create_sales_data):
    ...
    def test_get_top_products(self, client: TestClient, auth_headers: dict, create_sales_data):
    ...
    def test_get_daily_sales(self, client: TestClient, auth_headers: dict, create_sales_data):
    ...
    def test_get_sales_by_payment_method(self, client: TestClient, auth_headers: dict, create_sales_data):
